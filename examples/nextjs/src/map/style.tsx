...
/**
 * Neutral palette, shared by every store map. Ordered back to front: document
 * order is paint order.
 *
 * Editing this file changes every rendered map, which is why `STYLE_VERSION` in
 * `src/render/key.ts` has to be bumped alongside it.
 */
